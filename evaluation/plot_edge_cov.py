...
if(len(sys.argv) < 2):
    print("[usage] python3 plot_edge_cov.py [src1_plotdata_path] [label_1] [src2_plotdata_path] [label_2] [out_dir_path] [output_name] [title]")
else:
    ...
    out_dir = str(sys.argv[5]) + output_name
...
'''
    ...
    plt.plot(final_time_1, edge_1, color=(255/255, 100/255, 100/255), label=label_1 )
    plt.plot(final_time_2, edge_2, color=(100/255, 100/255, 255/255), label=label_2)
    plt.legend()
    plt.savefig(out_dir)
    plt.show()
